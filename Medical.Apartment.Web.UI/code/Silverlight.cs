...
using Medical.Apartment.Web.UI.Shared;
using Medical.Apartment.Common;

namespace Medical.Apartment.Web.UI.Controls
{
        ...
        protected void RenderContent(HtmlTextWriter writer)
        {
            string content = string.Format(
                @"<object data=""data:application/x-silverlight-2,"" type=""application/x-silverlight-2""
                    ...
                    <param name=""source"" value=""{0}/ClientBin/Medical.Apartment.Silverlight.UI.xap?v={1}"" />
                ...
                , string.IsNullOrEmpty(MedicalSettings.VirtualDirectory()) ? string.Empty : ("/" + MedicalSettings.VirtualDirectory())                
