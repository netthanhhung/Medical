<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SilverlightMinWidthResizer.ascx.cs" Inherits="Medical.Apartment.Web.UI.Shared.SilverlightMinWidthResizer" %>
<!--[if IE 6]>
