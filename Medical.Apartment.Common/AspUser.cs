...
namespace Medical.Apartment.Common
{
    ...
    public partial class AspUser : INotifyPropertyChanged
    {
        ...
        public static class ColumnNames
        {
            ...
            public const string MinRoleLevel = "MinRoleLevel";
        ...
        private int? _minRoleLevel;
        [DataMember]
        public int? MinRoleLevel { get { return _minRoleLevel; } set { if (!this.MinRoleLevel.Equals(value)) { _minRoleLevel = value; RaisePropertyChanged("MinRoleLevel"); } } }
